...
class TestDGMSOLVER(unittest.TestCase):
    ...
    def test_dgmsolver_partisn_eigen_2g_l7(self):
        ...
        pydgm.control.source_value = 0.0
        pydgm.control.boundary_type = [1.0, 1.0]
        pydgm.control.scatter_legendre_order = 4
        ...
        # Partisn output flux
        phi_test = [[3.433326, 3.393179, 3.323275, 0.01039435, 0.03345249, 0.02305814, -0.01464901, -0.002357446, 0.02421764, -0.002860552, -0.01350865, -0.0106481], [1.051014, 1.092735, 1.169607, -0.009161118, -0.0291115, -0.01995038, 0.009477224, 0.004573886, -0.01219304, 0.0006247422, 0.005792735, 0.005167993]]
