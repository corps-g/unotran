...
class TestWG_SOLVER(unittest.TestCase):
    ...
    def test_wg_solver_wg_solve_1_loop(self):
        ...
        psi_test = np.array([[0.74789724066688767, 1.0164427642376821, 1.7463807889213092, 1.1738899625537731],
                             [0.71457173895342729, 0.90414923839142525, 1.3700287382701124, 1.047194766946983],
                             [0.69725052556455225, 0.88208317443622986, 1.3492112798558475, 1.0125866380708275]])
    ...
    def test_wg_solver_wg_solve_10_loop(self):
        ...
        psi_test = np.array([[8.4110546157322599, 9.1833418653517462, 9.5936956365879666, 8.8254852462930931],
                             [5.0752325933222497, 5.2668991482206478, 5.4404764864419803, 5.2536056771005519],
                             [3.0503289650786818, 3.0973688798583501, 3.1261733488806658, 3.0840783765680735]])
