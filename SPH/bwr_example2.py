...
if __name__ == '__main__':
    ...
    pickle.dump(ass1, open('{}/refXS_sph_{}.p'.format(data_path, G), 'wb'))

    # Get the homogenized cross sections without homog over energy
    mapping = structure(G, Grouping(G, 'full', 1, 'contiguous_max', range(G), 0.0, 1.3, 60, None))
    ass1 = runSPH(G, assay_map, xs_name, mapping)
    pickle.dump(ass1, open('{}/refXS_sph_space_{}.p'.format(data_path, G), 'wb'))
